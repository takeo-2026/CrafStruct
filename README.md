...
本アプリは **Java 実行環境（Temurin 21 以上）を利用する軽量 ZIP 版**として提供しています。  
ZIP を解凍し、同梱の **CrafStruct.bat** を実行するだけで利用できます。
...
### 1. Java のインストール
本アプリの実行には **Java（Temurin 21 以上）** が必要です。

1. [https://adoptium.net/](https://adoptium.net/) を開く  
2. Temurin 21 (LTS) を選択  
3. Windows x64 MSI をダウンロード  
4. インストーラを実行し、画面の案内に従って進めてください

### 2. ZIP の展開
ダウンロードした ZIP を任意の場所に展開してください。

### 3. アプリの起動
展開したフォルダ内の **CrafStruct.bat** を実行します。
