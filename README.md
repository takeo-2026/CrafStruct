...
## 📥 ダウンロード
下記の OneDrive 公開リンクから ZIP をダウンロードして下さい。

https://1drv.ms/u/c/acca95b0f79fb580/IQDARmZrZOjVRJvD9xszyjIxAQ3xQJu9C2VPFRR3nkl_e1Q?e=e8SXtW
...
初回起動時に Microsoft Defender SmartScreen が  
「Windows によって PC が保護されました」  
と表示される場合があります。

これは **“未署名の新しいアプリを一時的に止める” Windows の通常動作** であり、  
アプリに問題があることを示すものではありません。
...
### なぜ表示されるのか
- 個人開発アプリで **コード署名を行っていないため**  
- **ビルド更新直後**で SmartScreen の信頼度（reputation）がまだ無いため  

いずれも一般的な挙動で、アプリの動作には影響しません。
